...
export const SignUpThree = (e) => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex items-center justify-center px-4 sm:px-6 lg:px-8 sm:py-16 lg:py-24">
        <div className="xl:w-full xl:max-w-sm 2xl:max-w-md ">
          ...
          <div className="mt-3 space-y-3">
            ...
            >
              <div className="flex items-center p-4 h-8">
                <svg
                  className="w-6 h-6 text-rose-500 backdrop-blur-0 background-color-FFFFCC"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
